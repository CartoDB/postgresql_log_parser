...
class PyParsingTestCase(unittest.TestCase):
    ...
    def test_postgresql_log_line_should_be_parsed_correctly(self):
        ...
        self.assertEqual(parsed_data['timestamp'], '2017-02-09 08:17:40 GMT')
        ...
        self.assertEqual(parsed_data['part'], '1')
        self.assertEqual(parsed_data['timestamp'], '2017-02-09 08:17:07 GMT')
    ...
    def test_postgresl_discard_unuseful_data(self):
        fixture = from_fixture('discard_queries.txt')
        parsed_data = self.parser.parse_line(fixture[0])
